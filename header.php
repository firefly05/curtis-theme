        ...
        <!-- footer -->
           <div class="small-12 columns footer clearfix">
            <div class="small-12 columns toolbox">
              ...
              <span class="toolbox-logo-wrap"><a href="#" target="_blank"><img class="toolbox-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/img/toolboxlogos/code-kit.png" /></a></span>
              <span class="toolbox-logo-wrap"><a href="#" target="_blank"><img class="toolbox-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/img/toolboxlogos/foundation-zurb.png" /></a></span>
